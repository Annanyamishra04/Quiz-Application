...
const Signup = ({ onSignupSucess = null}) => {
  ...
  const handleSubmit = async (ev) =>{
    ...
    try {
        ...
        if(!resp.ok){
            const msg= data?.message || "Registeraion Failed";
            setSubmitError(msg);
            return;
        }
        ...
        if(typeof onSignupSucess === 'function'){
            try{
               onSignupSucess(
                data.user || {
                    name: name.trim(),
                ...
                <div className={signupStyles.animatedBorder}>
                    <div className={signupStyles.formContent}>
                        ...
                        <p className={signupStyles.subtitle}>
                            Sign in to continue to Brain Blitz. Light, clean UI-smooth
                        ...
                        <label className={signupStyles.label}>
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input 
                                type ={showPassword ? 'text' : 'password'} name="password" value={password} onChange={(e)=>{
